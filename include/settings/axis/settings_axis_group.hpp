...
#include "setting_axis_homeswitchpos.hpp"
...
class SettingsAxisGroup : public SettingsGroup {
    private:
        ...
        AxisHomeSwitchPosSetting _homeSwitchPos = AxisHomeSwitchPosSetting(_motor);
        AxisMaxSpeedSetting _maxSpeed = AxisMaxSpeedSetting(_motor);

        ISetting* _settings[4] = {&_swLimitM, &_swLimitP, &_homeSwitchPos, &_maxSpeed};
