...
const char* GameYBallBounceInversionOvershootSetting::getDescription() const {
    ...
    {
        case 50:
            return "Ball Y-Axis overshoot distance when a bounce inversion occurs at 50% speed";
        case 60:
            return "Ball Y-Axis overshoot distance when a bounce inversion occurs at 60% speed";
        case 70:
            return "Ball Y-Axis overshoot distance when a bounce inversion occurs at 70% speed";
        case 80:
            return "Ball Y-Axis overshoot distance when a bounce inversion occurs at 80% speed";
        case 90:
            return "Ball Y-Axis overshoot distance when a bounce inversion occurs at 90% speed";
        case 100:
            return "Ball Y-Axis overshoot distance when a bounce inversion occurs at 100% speed";
        default:
